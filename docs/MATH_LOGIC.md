...
| `/api/features/online/as_of`                                                | Training-time PIT endpoint for model fit scripts |
...
- Predictor fits degenerate-class inputs (all scheduled / none scheduled) → mean-ratio fallback
